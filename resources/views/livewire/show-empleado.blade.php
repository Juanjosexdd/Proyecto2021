            ...
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach ($empleados as $empleado)
                        <tr>
                            <td><a href=" {{ route('admin.empleados.show', $empleado) }} ">{{ $empleado->id }}</a></td>
                            <td><a href=" {{ route('admin.empleados.show', $empleado) }} ">{{ $empleado->tipodocumento->abreviado }}-{{ $empleado->cedula }}</a></td>
                            <td><a href=" {{ route('admin.empleados.show', $empleado) }} ">{{ $empleado->nombres }} {{ $empleado->apellidos }}</a></td>
                            {{-- <td>{{ $empleado->email }}</a>
                            </td> --}}
                            <td><a href=" {{ route('admin.empleados.show', $empleado) }} ">{{ $empleado->cargo->nombre }}</a></td>
                            <td>
