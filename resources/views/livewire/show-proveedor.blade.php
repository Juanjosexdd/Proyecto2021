                            ...
                            @foreach ($proveedors as $proveedor)
                                <tr>
                                    <td><a href="" data-toggle="modal"
                                            data-target="#modal-default">{{ $proveedor->id }}</a></td>
                                    <td><a href="" data-toggle="modal"
                                            data-target="#modal-default">{{ $proveedor->tipodocumento->abreviado }}-{{ $proveedor->cedularif }}</a>
                                    </td>
                                    <td><a href="" data-toggle="modal"
                                            data-target="#modal-default">{{ $proveedor->nombre }}</a></td>
                                    <td><a href="" data-toggle="modal"
                                            data-target="#modal-default">{{ $proveedor->correo }}</a></td>
                                    <td>
                                        ...
                                        <div class="btn-group">
                                            <a type="button" class="btn btn-default btn-sm"
                                                ...
                                                @if ($proveedor->estatus == 1)
                                                    <form class="formulario-estatus"
                                                        action="{{ route('admin.proveedors.estatuproveedor', $proveedor) }}" method="get">
                                                        @csrf
                                            ...
                                            <a type="button" class="btn btn-default btn-sm"
                                                ...
                                                <form class="formulario-eliminar"
                                                    action="{{ route('admin.proveedors.destroy', $proveedor) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
