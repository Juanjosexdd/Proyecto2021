<div class="card elevation-5 col-md-12 col-sm-12 pt-3" style="border-radius: 0.95rem">
    <div class="card-header" style="padding: .75rem .25rem">
        <div class="input-group mb-3">
            ...
            <a href="{{ route('admin.ciudads.create') }}" class="btn bg-navy btn-sm px-2 elevation-4"><i
                            ...
                            <td width="4px">
                                <div class="btn-group">
                                    <a type="button" class="btn btn-default btn-sm"
                                        ...
                                        @if ($ciudad->estatus == 1)
                                            <form class="formulario-estatus"
                                                action="{{ route('admin.ciudads.estatuciudad', $ciudad) }}" method="get">
                                                @csrf
                                    ...
                                    <a class="btn btn-default btn-sm" style="border-color: rgb(158, 157, 157); border-top-left-radius: 0px; border-bottom-left-radius: 0px;"
                                        href=" {{ route('admin.ciudads.edit', $ciudad) }} "><i
                                    ...
                                    <a type="button" class="btn btn-default btn-sm"
                                        ...
                                        <form class="formulario-eliminar"
                                            action="{{ route('admin.ciudads.destroy', $ciudad) }}" method="POST">
                                            @csrf
                                            @method('delete')
