...
<div class="row">
    ...
    <div class="col-md-1">
        ...
        {!! Form::select('tipodocumento_id', $tipodocumentos, null, ['class' => 'form-control select2']) !!}
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <div class="input-group" bis_skin_checked="1">
                ...
                {!! Form::number('celular', null, ['class' => 'form-control' . ($errors->has('celular') ? ' is-invalid' : ''), 'placeholder' => 'Celular']) !!}
